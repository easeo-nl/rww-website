...
$pageTitle = page_content('keuken', 'seo_title', 'Keukenrenovatie op maat — RWW Bouw');
$metaDescription = page_content('keuken', 'seo_description', 'Complete keukenrenovatie in Amersfoort en omgeving. Tegelwerk, keukenplaatsing, elektra. Eerst tekenen, dan bouwen.');
$htmlLang = 'nl';
...
?>
  ...
  <section id="hero" class="relative min-h-screen flex items-center overflow-hidden">
    ...
    <div class="absolute inset-0">
      <img
        src="<?= e(page_content('keuken', 'hero_image', '/images/uploads/keuken/PHOTO-2026-04-09-09-24-05.jpg')) ?>"
        alt="Keukenrenovatie door RWW Bouw"
      ...
      <div class="max-w-7xl mx-auto px-6 sm:px-10 lg:px-14 xl:px-20 py-36 lg:py-44">
        <div class="max-w-xl lg:max-w-2xl">
          ...
          <span class="inline-flex items-center gap-3 text-rww-red font-semibold text-sm uppercase tracking-widest mb-6">
            ...
            <?= e(page_content('keuken', 'hero_eyebrow', 'Keukenrenovatie · Amersfoort')) ?>
          </span>

          <h1 class="font-display text-5xl sm:text-6xl xl:text-7xl text-white font-bold leading-tight mb-6">
            <?= page_content('keuken', 'hero_titel', 'Keuken op maat —<br><em class="italic text-rww-red">van tekening</em><br>tot tegels.') ?>
          </h1>

          <p class="text-stone-300 text-lg leading-relaxed mb-10 max-w-lg">
            <?= e(page_content('keuken', 'hero_subtitel', 'Onze architect tekent uw keuken op maat. Rafael en zijn team bouwen hem precies zoals gepland. Tegelwerk, keukenplaatsing, elektra — alles door één team.')) ?>
          </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="ubi-track">
        ...
        $usps = [
          ...
          [
            'label' => 'Keukenplaatsing<br>en tegelwerk',
            'icon'  => '<svg viewBox="0 0 32 32" fill="none" stroke="#991B1B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="28" height="28"><rect x="3" y="16" width="26" height="12" rx="1.5"/><rect x="3" y="3" width="26" height="10" rx="1.5"/><line x1="9" y1="16" x2="9" y2="28"/><line x1="23" y1="16" x2="23" y2="28"/></svg>',
          ],
          [
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div class="fade-in">
          ...
          <h2 class="font-display text-4xl sm:text-5xl lg:text-6xl text-white font-bold leading-tight mt-4 mb-6">
            <?= page_content('keuken', 'ontwerp3d_titel', 'Eerst zien.<br><em class="italic text-rww-red">Dan</em> beslissen.') ?>
          </h2>
          <p class="text-stone-300 text-lg leading-relaxed mb-8">
            <?= e(page_content('keuken', 'ontwerp3d_tekst', 'U krijgt een 3D-tekening van uw keuken — ingemeten op de centimeter, met de opstelling en materialen die u zelf kiest. Pas dan zetten we de schop in de grond.')) ?>
          </p>
          <div>
        ...
        <div class="fade-in">
          <div class="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10">
            ...
            <img
              src="<?= e(page_content('keuken', 'ontwerp3d_afbeelding', '/images/uploads/tekeningen/PHOTO-2026-04-09-09-05-19.jpg')) ?>"
              alt="3D-ontwerp keukenrenovatie door RWW Bouw"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center max-w-3xl mx-auto mb-16 fade-in">
        ...
        <h2 class="font-display text-3xl sm:text-4xl lg:text-5xl text-rww-dark mt-4 mb-6 font-bold">
          <?= e(page_content('keuken', 'werkwijze_titel', 'Helder. Eerlijk. Zonder verrassingen.')) ?>
        </h2>
        <p class="text-rww-muted text-lg"><?= e(page_content('keuken', 'werkwijze_intro_tekst', 'Van eerste contact tot uw nieuwe keuken — u weet precies wat u kunt verwachten.')) ?></p>
      </div>
      ...
      <div class="zwh-grid fade-in">
        ...
        $stappen = [
          ...
          [
            ...
            'tekst' => 'We komen bij u thuis, meten uw keuken op en bespreken uw wensen.',
            'pill'  => 'Vrijblijvend',
          ...
          [
            ...
            'tekst' => 'Onze architect tekent uw keuken op maat — u ziet het resultaat vóór de schop erin gaat.',
            'pill'  => 'Gratis ontwerp',
  ...
  <!-- SECTION: projecten -->
  <?php $keuken_fotos = get_service_fotos('keuken'); ?>
      ...
      <div class="fade-in">
        <div class="slider-container" data-slider data-slider-focus>
          <div class="slider-track" data-slider-track>
            <?php foreach ($keuken_fotos as $foto): ?>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div class="fade-in order-2 lg:order-1">
          ...
          <h2 class="font-display text-3xl sm:text-4xl lg:text-5xl text-rww-dark font-bold leading-tight mt-4 mb-6">
            <?= page_content('keuken', 'voorna_titel', 'Van oud naar nieuw —<br>zie het verschil zelf.') ?>
          </h2>
          <p class="text-rww-muted text-lg leading-relaxed mb-8">
            <?= e(page_content('keuken', 'voorna_tekst', 'Elke keuken die we opleveren was ooit een verouderde ruimte. We slopen alles schoon en bouwen opnieuw — met uw wensen als uitgangspunt, en uw budget als grens.')) ?>
          </p>
          <ul class="space-y-3 mb-8 text-rww-text">
            <li class="flex items-start gap-3">
              ...
              <span>Volledige sloop en opbouw — schone lei</span>
            </li>
            <li class="flex items-start gap-3">
              <svg class="w-5 h-5 text-rww-red mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
              <span>Eigen vakmensen — tegelzetters, loodgieters, elektriciens</span>
            </li>
            <li class="flex items-start gap-3">
              <svg class="w-5 h-5 text-rww-red mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
        ...
        <div class="fade-in order-1 lg:order-2 flex justify-center">
          <div class="relative w-full max-w-lg">
            ...
            <div class="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] bg-stone-200">
              <img id="vn-voor"
                src="<?= e(page_content('keuken', 'voor_afbeelding', '/images/uploads/keuken/PHOTO-2026-04-09-09-05-19 3.jpg')) ?>"
                alt="Keuken vóór renovatie"
                class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500">
              <img id="vn-na"
                src="<?= e(page_content('keuken', 'na_afbeelding', '/images/uploads/keuken/PHOTO-2026-04-09-09-24-07 3.jpg')) ?>"
                alt="Keuken na renovatie door RWW Bouw"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        ...
        <div class="fade-in lg:sticky lg:top-28">
          ...
          <h2 class="font-display text-4xl sm:text-5xl lg:text-6xl text-white font-bold leading-tight mt-4 mb-6">
            <?= page_content('keuken', 'diensten_titel', 'Alles door<br><em class="italic text-rww-red">één</em> team.') ?>
          </h2>
          <p class="text-stone-400 text-lg leading-relaxed mb-8">
            <?= e(page_content('keuken', 'diensten_tekst', 'Van sloopwerk en leidingwerk tot tegels en de laatste afwerking — u heeft één aanspreekpunt, één offerte, geen losse onderaannemers die het op elkaar afschuiven.')) ?>
          </p>
          <a href="offerte.php" class="inline-flex items-center gap-2 bg-rww-red hover:bg-rww-red-light text-white px-8 py-4 rounded-full text-base font-semibold transition-colors">
            Offerte aanvragen
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
        ...
        <div class="fade-in divide-y divide-white/10">
          ...
          $diensten = [
            [
              'titel' => 'Keukenplaatsing op maat',
              'tekst' => 'Nieuwe keuken plaatsen, inclusief maatwerk kasten, werkblad en achterwand. Strak gemonteerd, precies op maat.',
              'icon'  => '<svg viewBox="0 0 40 40" fill="none" stroke="#991B1B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="28" height="28"><rect x="4" y="18" width="32" height="16" rx="1.5"/><rect x="4" y="6" width="32" height="9" rx="1.5"/><line x1="12" y1="18" x2="12" y2="34"/><line x1="28" y1="18" x2="28" y2="34"/><circle cx="20" cy="10.5" r="1.5"/></svg>',
            ],
            [
              'titel' => 'Tegelwerk en achterwand',
              'tekst' => 'Keukentegels op de vloer en wand — spatschermen, grote platen, metro-tegels. Strak gelegd, netjes gevoegd.',
            ...
            [
              ...
              'tekst' => 'Nieuwe groepen, stopcontacten op de juiste plek, wateraansluiting en afvoer — alles door ons eigen team.',
              'icon'  => '<svg viewBox="0 0 40 40" fill="none" stroke="#991B1B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="28" height="28"><path d="M22 4l-8 16h10l-8 16"/><path d="M10 20h20"/></svg>',
            ],
            [
              'titel' => 'Sloopwerk en afvoer',
              'tekst' => 'Oude keuken volledig slopen en afvoeren — schone lei, klaar voor de nieuwe situatie.',
  ...
  $faq_items = [
    ...
    [
      ...
      'antwoord' => 'Onze binnenhuisarchitect, neemt het ontwerp voor haar rekening. Ze adviseert over kleur, indeling en materialen en maakt een 3D visualisatie zodat u precies weet hoe het eruit komt te zien voordat er ook maar één kastje wordt geplaatst.',
    ],
    [
