...
?>
  ...
  <section id="hero" class="relative min-h-screen flex items-center overflow-hidden">
    ...
    <div class="absolute inset-0">
      <img
        src="<?= e(page_content('badkamer', 'hero_image', '/images/uploads/badkamer/PHOTO-2026-04-09-08-47-01.jpg')) ?>"
        alt="Badkamerrenovatie door RWW Bouw"
      ...
      <div class="max-w-7xl mx-auto px-6 sm:px-10 lg:px-14 xl:px-20 py-36 lg:py-44">
        <div class="max-w-xl lg:max-w-2xl">
          ...
          <span class="inline-flex items-center gap-3 text-rww-red font-semibold text-sm uppercase tracking-widest mb-6">
            ...
            <?= e(page_content('badkamer', 'hero_eyebrow', 'Badkamerrenovatie · Amersfoort')) ?>
          </span>

          <h1 class="font-display text-5xl sm:text-6xl xl:text-7xl text-white font-bold leading-tight mb-6">
            <?= page_content('badkamer', 'hero_titel', 'Badkamer op maat —<br><em class="italic text-rww-red">van tekening</em><br>tot tegels.') ?>
          </h1>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div class="fade-in">
          ...
          <h2 class="font-display text-4xl sm:text-5xl lg:text-6xl text-white font-bold leading-tight mt-4 mb-6">
            <?= page_content('badkamer', 'ontwerp3d_titel', 'Eerst zien.<br><em class="italic text-rww-red">Dan</em> beslissen.') ?>
          </h2>
          <p class="text-stone-300 text-lg leading-relaxed mb-8">
            <?= e(page_content('badkamer', 'ontwerp3d_tekst', 'U krijgt een 3D-tekening van uw badkamer — ingemeten op de centimeter, met de materialen die u zelf kiest. Pas dan zetten we de schop in de grond.')) ?>
          </p>
          <div>
        ...
        <div class="fade-in">
          <div class="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10">
            ...
            <img
              src="<?= e(page_content('badkamer', 'ontwerp3d_afbeelding', '/images/uploads/tekeningen/PHOTO-2026-04-09-09-05-22 4.jpg')) ?>"
              alt="3D-ontwerp badkamerrenovatie door RWW Bouw"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center max-w-3xl mx-auto mb-16 fade-in">
        ...
        <h2 class="font-display text-3xl sm:text-4xl lg:text-5xl text-rww-dark mt-4 mb-6 font-bold">
          <?= e(page_content('badkamer', 'werkwijze_titel', 'Helder. Eerlijk. Zonder verrassingen.')) ?>
        </h2>
        <p class="text-rww-muted text-lg"><?= e(page_content('badkamer', 'werkwijze_intro_tekst', 'Van eerste contact tot uw nieuwe badkamer — u weet precies wat u kunt verwachten.')) ?></p>
      </div>
      ...
      <div class="zwh-grid fade-in">
        ...
        $stappen = [
          ...
          [
            ...
            'tekst' => 'We komen bij u thuis, meten uw badkamer op en bespreken uw wensen.',
            'pill'  => 'Vrijblijvend',
          ...
          [
            ...
            'tekst' => 'Agnieszka tekent uw badkamer op maat — u ziet het resultaat vóór de schop erin gaat.',
            'pill'  => 'Gratis ontwerp',
  ...
  <!-- /SECTION: werkwijze -->
   ...
   <!-- SECTION: projecten -->
  <?php $badkamer_fotos = get_service_fotos('badkamer'); ?>
      ...
      <div class="fade-in">
        <div class="slider-container" data-slider data-slider-focus>
          <div class="slider-track" data-slider-track>
            <?php foreach ($badkamer_fotos as $foto): ?>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div class="fade-in order-2 lg:order-1">
          ...
          <h2 class="font-display text-3xl sm:text-4xl lg:text-5xl text-rww-dark font-bold leading-tight mt-4 mb-6">
            <?= page_content('badkamer', 'voorna_titel', 'Van oud naar nieuw —<br>zie het verschil zelf.') ?>
          </h2>
          <p class="text-rww-muted text-lg leading-relaxed mb-8">
            <?= e(page_content('badkamer', 'voorna_tekst', 'Elke badkamer die we opleveren was ooit een verouderde ruimte. We slopen alles schoon en bouwen opnieuw — met uw wensen als uitgangspunt, en uw budget als grens.')) ?>
          </p>
          <ul class="space-y-3 mb-8 text-rww-text">
            ...
            <li class="flex items-start gap-3">
              <svg class="w-5 h-5 text-rww-red mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
              <span>Eigen vakmensen — tegelzetters, loodgieters, stucadoors</span>
            </li>
            <li class="flex items-start gap-3">
              <svg class="w-5 h-5 text-rww-red mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
        ...
        <div class="fade-in order-1 lg:order-2 flex justify-center">
          <div class="relative w-full max-w-lg">
            ...
            <div class="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] bg-stone-200">
              <img id="vn-voor"
                src="<?= e(page_content('badkamer', 'voor_afbeelding', '/images/uploads/20230329_151355.jpg')) ?>"
                alt="Badkamer vóór renovatie"
                class="absolute inset-0 w-full h-full object-cover transition-opacity duration-500">
              <img id="vn-na"
                src="<?= e(page_content('badkamer', 'na_afbeelding', '/images/uploads/IMG-20230330-WA0002.jpg')) ?>"
                alt="Badkamer na renovatie door RWW Bouw"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        ...
        <div class="fade-in lg:sticky lg:top-28">
          ...
          <h2 class="font-display text-4xl sm:text-5xl lg:text-6xl text-white font-bold leading-tight mt-4 mb-6">
            <?= page_content('badkamer', 'diensten_titel', 'Alles door<br><em class="italic text-rww-red">één</em> team.') ?>
          </h2>
        ...
        <div class="fade-in divide-y divide-white/10">
          ...
          $diensten = [
            [
              ...
              'tekst' => 'Vloer- en wandtegels in elk formaat — grote platen, patroonvloeren, inloopdouche op maat. Strak gelegd, netjes gevoegd.',
            ...
            [
              ...
              'tekst' => 'Inloopdouche, bad, toilet, wastafel en meubels — inclusief al het leidingwerk. Alles door ons eigen team.',
